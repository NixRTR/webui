...
app.include_router(apprise_config_router)  # Include before apprise_router to avoid route conflict
app.include_router(apprise_router)  # Moved after apprise_config_router
